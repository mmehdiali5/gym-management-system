...
if(isset($_POST['done'])){
	...
	$q="update members set MID= $MID,MName='$MName',email='$email',HouseNo='$HouseNo',StreetNo='$StreetNo',City='$City',Country='$Country' where MID=$MID";
				...
				<form  method="post" autocomplete="off">
					...
					<div class="card">
							...
							<div class="card-header bg-dark">
									<h1 class="text-white text-center">  UPDATE MEMBERS INFO</h1>
							</div> <br>
