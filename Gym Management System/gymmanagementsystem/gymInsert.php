...
if(isset($_POST['done'])){
	...
	$q="INSERT INTO `gym`(`gymID`,`gymType`, `gymDescription`,`gymAddress`) VALUES ('$gymID','$gymType','$gymDescription','$gymAddress')";
				...
				<form  method="post" autocomplete="off">
					...
					<div class="card">
							...
							<div class="card-header bg-dark">
									<h1 class="text-white text-center">  INSERT GYM INFO</h1>
							</div> <br>
							<label> GYM ID:</label>
